            ...
            <div class="swiper one-item-slider">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <img
                    src="assets/img/pdp-banner-slide.jpg"
                    alt="Banner image"
                  />
                </div>
                <div class="swiper-slide">
          ...
          <section class="max-apoclypse">
            ...
            >
              ...
              <a
                ...
                data-aos-delay="400"
              >
                <img src="assets/img/ic-like.svg" alt="" class="normal-img" />
                <img src="assets/img/ic-like-a.svg" alt="" class="active-img" />
              </a>
            </div>
            <div
              ...
              >
                ...
                >
                  <div class="product-rating d-flex me-2">
                    <img class="me-1" src="assets/img/star-a.svg" alt="" />
                    <img class="me-1" src="assets/img/star-a.svg" alt="" />
                    <img class="me-1" src="assets/img/star-a.svg" alt="" />
                    <img class="me-1" src="assets/img/star-a.svg" alt="" />
                    <img src="assets/img/star-h.svg" alt="" />
                  </div>
            ...
            <ul class="nav nav-tabs product-future-list justify-content-md-end" id="myTab" role="tablist">
              <li class="nav-item" role="presentation">
                <a
                  ...
                  data-bs-toggle="tab"
                >
                  <img src="assets/img/ic-description.svg" alt="" />
                  <p class="product-future-text text-uppercase">
                    Description
                  </p>
                  <img
                    class="icon position-absolute"
                    src="assets/img/ic-up-arrow.svg"
                    alt=""
                  />
                </a>
              </li>
              <li class="nav-item" role="presentation">
                <a
                  ...
                  data-bs-toggle="tab"
                >
                  <img src="assets/img/ic-specifications.svg" alt="" />
                  <p class="product-future-text text-uppercase">
                    Specifications
                  </p>
                  <img
              ...
              <li class="nav-item" role="presentation">
                <a
                  ...
                  data-bs-toggle="tab"
                >
                  <img src="assets/img/ic-reviews.svg" alt="" />
